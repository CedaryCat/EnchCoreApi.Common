...
namespace EnchCoreApi.Common.IO.LibDeflate.Buffers;
...
public static class ObjectMarshal
{
    ...
    /// <returns>
    /// The <see cref="nint"/> value representing the offset to the target field from the start of the object data
    ...
    public static nint DangerousGetObjectDataByteOffset<T>(object obj, ref T data)
    {
    ...
    [Pure]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ref T DangerousGetObjectDataReferenceAt<T>(object obj, nint offset)
    {
        RawObjectData? rawObj = Unsafe.As<RawObjectData>(obj)!;
        ref byte r0 = ref rawObj.Data;
