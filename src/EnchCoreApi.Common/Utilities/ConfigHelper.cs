...
namespace EnchCoreApi.Common.Utilities
{
    public abstract class ConfigHelper
    {
        ...
        public abstract bool LoadFromFile<T>(string filePath, [NotNullWhen(true)] out T? config) where T : class, new();
        /// <summary>
        /// 
        /// </summary>
        /// <typeparam name="T"></typeparam>
        ...
        /// <returns></returns>
        public T EnsureConfigExist<T>(string filePath, Func<T> defaultConfig) where T : class, new() {
